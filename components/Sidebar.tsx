  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-4 left-4 z-50">
        ...
        >
          {isOpen ? <X size={20} className="text-blue-900" /> : <Menu size={20} className="text-blue-900" />}
        </button>
      </div>
      ...
      >
        ...
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 mb-4 text-sm space-y-2">
          ...
          <div className="flex justify-between items-center text-gray-700">
            <span>Rewards</span>
            <span className="font-semibold text-green-600">${rewardAmount}</span>
          </div>
          {milestone && (
            <div className="flex justify-between items-center text-gray-700">
              <span>Milestone</span>
        ...
        <div className="mt-auto text-sm border-t py-6">
          <Link href="/help" className="flex items-center gap-2 text-blue-600 hover:underline mb-3">
